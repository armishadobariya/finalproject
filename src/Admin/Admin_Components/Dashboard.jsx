		...
		<>
			...
			<div >
				...
				{loading ? (
					...
					<div className=' tw-ml-[250px] md:tw-mt-[-1100px] tw-mt-[-500px] p-3 '>
						...
						<div className='user_info'>
							{/* <div className=''>
								...
								<div className='recent_activity '>
									<Grid container spacing={3} marginTop={5}>
										<Grid item xs={12} sm={12} md={6} className='md:tw-ml-[610px] md:tw-mt-[-399px] '>
											<Card className={`shadow-lg`}>
												<CardContent >
													<div className='flex'>
							...
							{/* <div className=''>
								...
								<div className='recent_activity '>
									<Grid container spacing={3} marginTop={5} style={{ marginTop: isCardOpen1 ? '-22.5rem' : 'unset' }}>
										<Grid item xs={12} sm={12} md={6} className='md:tw-ml-[610px]'>
											<Card className={`shadow-lg`}>
												<CardContent>
													<div className='flex'>
														<Typography variant="h6" className='tw-mt-[15px] tw-ml-[12px] tw-mr-[370px] '>
												...
												<CardContent>
													<div className='flex'>
														...
														<div className='tw-mt-[15px] tw-cursor-pointer tw-text-xs'>
															<KeyboardArrowDownIcon style={{ fontSize: 'large' }} onClick={toggleCard4} />
														</div>
