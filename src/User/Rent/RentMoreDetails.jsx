                ...
                <div className='tw-p-4'>
                    <div className="row">
                        ...
                        <div className='tw-mt-4'>
                            ...
                            <h5 class=" tw-text-gray-500 tw-flex"><h4 className='tw-cursor-pointer' onClick={() => navigate('/Rent')}>Rent </h4>
                                <span class="tw-text-gray-500 tw-ml-[5px] tw-mr-[2px]">  {' >'} </span>
                                <h4 className=' tw-cursor-pointer' onClick={() => navigate('/Rent/RentMoreDetails')}>More Details</h4>
                            </h5>
                        </div>
                    </div>
